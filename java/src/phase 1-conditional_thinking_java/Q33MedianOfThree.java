 ...
 * 
 * Mentor Tips (Java 26):
 * - Compare elements. The median is the one that is between the other two, or you can find the sum of all three and subtract the min and max.
 */
public class Q33MedianOfThree {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("a: "); double a = scanner.nextDouble();
                ...
                System.out.println("Median: " + solve(a, b, c));
        scanner.close();
    }
}
